...
var STAR_COMMON_NAMES = ["ARCTURUS", "ERIDANUS", "CYGNUS", "POLARIS", "CORVUS", "CARINA", "AIN", "CARCERI", "TARTARUS"];
var CONSTELLATION_NAMES_POSSESSIVE = ["CENTAURI", "CASSIOPEIAE", "ANDROMEDAE", "ORIONIS", "PEGASI", "PYXIDIS"];
var SMALL_BODY_COMMON_NAMES = ["CERES", "QUAOAR", "SEDNA", "ORCUS", "SALACIA", "VARUNA", "ERIS", "VULCAN", "IO", "EUROPA", "GANYMEDE", "CALLISTO", "LYSITHEA", "STYX", "NIX", "KERBEROS", "HYDRA", "IAPETUS", "ELARA", "DIA", "ANANKE", "THYONE", "AOEDE", "KALYKE", "CYLLENE", "MEGACLITE", "ERINOME", "DIA"];
var SMALL_BODY_SYSTEM_DERIVED_NAMES = ["I", "II", "III", "IV", "V", "VI", "VII", "VIII"];
var SMALL_BODY_SCIENTIFIC_NAMES = ["XV", "KZ", "QX", "GD"];
var GREEK_LETTERS = ["ALPHA", "BETA", "GAMMA", "DELTA", "EPSILON", "LAMBDA", "KAPPA"];
var USED_BODY_NAMES = [];
const PLANET_NAMING_STYLE_COMMON = 0;
const PLANET_NAMING_STYLE_SCIENTIFIC = 1;
const PLANET_NAMING_STYLE_SYSTEM_DERIVED = 2;
...
const WEAPON_TELEPORTATION_BAY = 15;
...
const BOARDING_ACTION_ATTACK_BRIDGE = 0;
const BOARDING_ACTION_RELEASE_PRISONERS = 1;
const BOARDING_ACTION_PLANT_EXPLOSIVES = 2;
const BOARDING_ACTION_CONSUME_ENERGY = 3;
const BOARDING_ACTION_STEAL_CREDITS = 4;
const BOARDING_ACTION_SLOW_SHIP = 5;
const BOARDING_ACTION_STANDBY= 6;

const BOARDING_DESCRIPTIONS = {}
BOARDING_DESCRIPTIONS[BOARDING_ACTION_ATTACK_BRIDGE] = "attempting to commandeer the ship";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_RELEASE_PRISONERS] = "attacking the brig to free prisoners";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_PLANT_EXPLOSIVES] = "planting explosive charges";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_CONSUME_ENERGY] = "sabotaging the reactor";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_STEAL_CREDITS] = "downloading BitCredits from onboard computers";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_SLOW_SHIP] = "venting coolant overboard to slow the ship down";
BOARDING_DESCRIPTIONS[BOARDING_ACTION_STANDBY] = "standing by for recall";
...
const nameWithDefArticle = function(team) {
	if (team == SHIP_FLAG_PLAYER) {
		return TEAM_NAME[SHIP_FLAG_PLAYER];
	}
	return `the ${TEAM_NAME[SHIP_FLAG_PLAYER]}`;
}
...
SHIP_ENERGY[SHIP_TYPE_TRANSPORT] = 15;
SHIP_ENERGY[SHIP_TYPE_CARRIER] = 20;
SHIP_ENERGY[SHIP_TYPE_BATTLESHIP] = 20;
...
SHIP_ENERGY_RECHARGE[SHIP_TYPE_TRANSPORT] = 3;
...
// p psilopod
// P pislopod matriarch

const SHIP_LOOT = {};
SHIP_LOOT[SHIP_TYPE_FIGHTER] = 0;
SHIP_LOOT[SHIP_TYPE_SLOOP] = 10;
SHIP_LOOT[SHIP_TYPE_FRIGATE] = 20;
SHIP_LOOT[SHIP_TYPE_TRANSPORT] = 200;
SHIP_LOOT[SHIP_TYPE_CARRIER] = 300;
SHIP_LOOT[SHIP_TYPE_BATTLESHIP] = 300;
SHIP_LOOT[SHIP_TYPE_DREADNOUGHT] = 1000;
SHIP_LOOT[SHIP_TYPE_STATION] = 400;
SHIP_LOOT[SHIP_TYPE_OTHER] = 20;
SHIP_LOOT[SHIP_TYPE_ARBITER] = 400;
SHIP_LOOT[SHIP_TYPE_WRAITH] = 100;

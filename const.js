...
var LARGE_BODIES = {80: BODY_STAR_YELLOW, 10: BODY_QUASAR, 10: BODY_BLACK_HOLE};
...
TILES[TERRAIN_QUASAR] = {
		51: {character : "~", color : "#73A", backgroundColor : "#CEF"},
		49: {character : "~", color : "#CEF", backgroundColor : "#73A"}};
TILES[TERRAIN_QUASAR_JET] = {
		40: {character : ":", color : "#314", backgroundColor : "#637"},
		40: {character : ":", color : "#637", backgroundColor : "#314"},
		20: {character : ".", color : "#000", backgroundColor : "#000"}};
TILES[TERRAIN_CORONA_YELLOW] = {
		60: {character : ":", color : "#CA1", backgroundColor : "#742"},
		40: {character : ".", color : "#000", backgroundColor : "#000"}};
...
TERRAINS[BODY_QUASAR] = {100: TERRAIN_QUASAR};

var CORONAS = {};
CORONAS[BODY_QUASAR] = {100: TERRAIN_QUASAR_JET};
CORONAS[BODY_STAR_YELLOW] = {100: TERRAIN_CORONA_YELLOW};
